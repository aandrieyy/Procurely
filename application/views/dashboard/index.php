													...
													<div class="row">
														...
														<div class="col-7 col-stats">
															<div class="numbers">
																...
																<h4 class="card-title">₱ <?php echo isset($budget_stats->allocated_pr) ? number_format($budget_stats->allocated_pr,2) : number_format(0,2) ?></h4>
															</div>
														</div>
													</div>
												</div>
...
<script>
	...
	if(!empty($report)){
		...
		var myPieChart = new Chart(pieChart, {
			...
			data: {
				datasets: [{
					data: [<?= number_format(($report_pending_ppmp / $report_ppmp) * 100,2) ?> ,<?= number_format(($report_approved_ppmp / $report_ppmp) * 100,2) ?> ,<?= number_format(($report_rejected_ppmp / $report_ppmp) * 100,2) ?>],
