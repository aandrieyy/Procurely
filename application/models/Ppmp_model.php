...
class Ppmp_model extends CI_Model{
    ...
    public function get_ppmp_item($id = null,$ppmp_id = null,$array_ppmp = null,$ppmp_item_status = null){
        // die($ppmp_item_status.'x');
        $this->db->select("b.*,a.*,c.category as mop,c.id as mop_id, d.id as ppmp_ids, a.project_item_id,
