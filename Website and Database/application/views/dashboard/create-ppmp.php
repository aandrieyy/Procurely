...
function get_project_items(project_id, selected_project_items){
	var products= '';
	$.ajax({
		type: 'ajax',
		method: 'post',
		...
		data:{
            ...
            selected_project_items: selected_project_items
        },
		async: false,
		dataType: 'text',
		success: function(response){
...
$(".addNewLine").click(function(){
	...
	var selected_project_items = {'data_table' : table_data}
	project_item = get_project_items(project_id,selected_project_items);
	// get_project_items
