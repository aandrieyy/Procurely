                            ...
                            <div class="card-body ">
                                <div class="row">
                                    ...
                                    <div class="col-9 col-stats">
                                        <div class="numbers">
                                            <p class="card-category">Annual Remaining Budget</p>
                                            <h4 class="card-title">₱ <?php echo isset($budget_stats->annual_remaining_budget) ? number_format($budget_stats->annual_remaining_budget,2) : number_format(0,2) ?></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card card-stats card-round">
                            <div class="card-body ">
                                <div class="row">
                                    ...
                                    <div class="col-9 col-stats">
                                        <div class="numbers">
                                            <p class="card-category">Total Sector Budget</p>
						...
						<div class="card">
							<div class="card-header">
								<div class="card-head-row">
									<h4 class="card-title">Sector Budget</h4>
									...
									<table id="multi-filter-select" class="display table table-striped table-hover" >
                                        ...
                                        <tbody>
											<?php foreach($data as $row): ?>
												<tr>
													<td hidden><?= $row->id?></td>
													<td><span class="badge badge-warning"><?= ucfirst($row->sector)?></span></td>
...
<?php $this->load->view('dashboard/modal/add-sector-budget')?>
...
<script>
	$('#btnAdd').click(function(){
		...
		$('#addRowModal').find('.modal-title').text('Sector Budget');
		$('#myForm').attr('action','<?php echo base_url() ?>sector_budget/save');
		$('#btnssave').text('Save');
	...
	function getEdit(id){
		...
		$('#myForm').attr('action','<?php echo base_url() ?>/sector_budget/update');
		...
		$.ajax({
			type: 'ajax',
			method: 'post',
			url: '<?php echo base_url()?>sector_budget/edit',
			data:{
				id:id
				},
			async: false,
