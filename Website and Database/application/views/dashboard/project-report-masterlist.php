					...
					<div class="col-md-12">
						<div class="card">
							...
							<div class="card-body">
                                ...
                                <form action="<?= base_url()?>projects/report_masterlist" method="POST" id="myForm">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group form-group-default fc-mb">
                                                <label><span class="text-danger">*</span> Date From:  </label>
                                                <input  type="date" name="date_from" id="date_from" class="form-control" value="<?php echo isset($date_from) ? $date_from : '' ?>"  >
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group form-group-default fc-mb">
                                                <label><span class="text-danger">*</span> Date To:  </label>
                                                <input  type="date" name="date_to" id="date_to" class="form-control" value="<?php echo isset($date_to) ? $date_to : '' ?>" >
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class="form-group form-group-default fc-mb">
                                                <label><span class="text-danger">*</span> Status:  </label>
                                                <select name="id_category_status" id="id_category_status" class="form-control" >
