...
class Items_model extends CI_Model{
    ...
    public function get($id = null,$item_type_id = null, $project_id = null, $selected_ppmp_item = null){
        ...
        if(!empty($selected_ppmp_item)){
            $this->db->where_not_in('a.id',$selected_ppmp_item);
        }
        ...
        // print_r($selected_ppmp_item);die($this->db->last_query());
        return $result;
    }
